...
public class MCRIIIFPresentationResource {
    ...
    private static final MCRCache<String, MCRIIIFPresentationManifestQuickAccess> cache = new MCRCache<>(1000, MCRIIIFPresentationResource.class.getName().toString());
    ...
    public Response getManifest(@PathParam("impl") String impl, @PathParam("identifier") String identifier) throws CloneNotSupportedException {
    ...
    protected Response.ResponseBuilder addHeaders(Response.ResponseBuilder builder) {
        return builder
                .header("Link", "<http://iiif.io/api/presentation/2/context.json>\n;rel=\"http://www.w3.org/ns/json-ld#context\";type=\"application/ld+json\"")
    ...
    public Response getSequence(@PathParam("impl") String impl, @PathParam("identifier") String identifier, @PathParam("name") String name) {
        MCRIIIFPresentationManifestQuickAccess quickAccess = getManifestQuickAccess(impl, identifier);
    ...
    public Response getCanvas(@PathParam("impl") String impl, @PathParam("identifier") String identifier, @PathParam("name") String name) {
        MCRIIIFPresentationManifestQuickAccess quickAccess = getManifestQuickAccess(impl, identifier);
    ...
    public Response getAnnotation(@PathParam("impl") String impl, @PathParam("identifier") String identifier, @PathParam("name") String name) {
        MCRIIIFPresentationManifestQuickAccess quickAccess = getManifestQuickAccess(impl, identifier);
    ...
    public Response getAnnotationList(@PathParam("impl") String impl, @PathParam("identifier") String identifier, @PathParam("name") String name) {
    ...
    public Response getRange(@PathParam("impl") String impl, @PathParam("identifier") String identifier, @PathParam("name") String name) {
        MCRIIIFPresentationManifestQuickAccess quickAccess = getManifestQuickAccess(impl, identifier);
    ...
    public Response getLayer(@PathParam("impl") String impl, @PathParam("identifier") String identifier, @PathParam("name") String name) {
        return null;
    }

    @GET
    @Path("{impl}/{identifier}/res/{name}[.]{format}")
    public Response getContent(@PathParam("impl") String impl, @PathParam("identifier") String identifier, @PathParam("name") String name, @PathParam("format") String format) {
        return null;
    }
