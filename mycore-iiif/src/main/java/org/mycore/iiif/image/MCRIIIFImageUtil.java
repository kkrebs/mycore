...
public class MCRIIIFImageUtil {
    ...
    public static String buildCanonicalURL(MCRIIIFImageImpl impl, String identifier) throws UnsupportedEncodingException {
        return "<" + getIIIFURL(impl) + URLEncoder.encode(identifier, "UTF-8") + "/full/full/0/color.jpg>;rel=\"canonical\"";
    }
