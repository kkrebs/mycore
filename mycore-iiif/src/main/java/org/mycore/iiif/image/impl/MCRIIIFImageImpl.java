...
public abstract class MCRIIIFImageImpl {
    ...
    public static synchronized MCRIIIFImageImpl getInstance(String implName) {
        ...
        try {
            ...
            throw new MCRConfigurationException("Configurated class (" + className + ") not found: " + classPropertyName, e);
        } catch (NoSuchMethodException e) {
            throw new MCRConfigurationException("Configurated class (" + className + ") needs a string constructor: " + classPropertyName);
    ...
    public abstract MCRIIIFImageInformation getInformation(String identifier) throws MCRIIIFImageNotFoundException, MCRIIIFImageProvidingException, MCRAccessException;
